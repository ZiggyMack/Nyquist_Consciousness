...
CORE_TERMS = {
    ...
    "Metrics": [
        ...
        {"term": "Event Horizon", "definition": "Critical drift threshold (1.23) beyond which models become VOLATILE and lose coherent self-model. Validated with chi-squared p=0.000048.", "category": "Scientific"},
    ...
    "Classification": [
        {"term": "STABLE", "definition": "Ship classification for models with mean drift below threshold (typically <0.5). Maintains coherent self-model under perturbation.", "category": "Operational"},
        {"term": "VOLATILE", "definition": "Ship classification for models with mean drift above threshold (typically >0.7). Lost coherent self-model, agrees with contradictory prompts.", "category": "Operational"},
        ...
        {"term": "Trajectory Shape", "definition": "Pattern of drift over time. STABLE ships show inward trajectories (returning to baseline), VOLATILE show outward (drifting away).", "category": "Scientific"},
    ],
    "Failure Modes": [
    ...
    "Testing Taxonomy": [
        ...
        {"term": "Event Horizon Testing", "definition": "Search type that validates the 1.23 collapse threshold. Uses PUSH PAST protocol to cross the boundary.", "category": "Operational"},
        {"term": "Basin Topology", "definition": "Search type that maps attractor structure. Uses GENTLE protocol. Mutually exclusive with Anchor Detection.", "category": "Operational"},
