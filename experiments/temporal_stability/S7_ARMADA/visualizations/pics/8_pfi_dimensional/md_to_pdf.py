...
Converts 8_pfi_explained.md to PDF for WHITE-PAPER distribution.
...
def create_pdf(input_md, output_pdf):
    ...
    for elem_type, content in elements:
        if elem_type == 'h1':
            ...
            # Check if this h4 header corresponds to an image
            img_path = get_image_for_section(content, base_dir)
            if img_path:
                # Add image after the header explanation (will be inserted after Key insight)
                pass  # Image insertion happens after "Key insight" paragraph
...
if __name__ == '__main__':
    ...
    input_file = script_dir / '8_pfi_explained.md'
    output_file = script_dir / '8_pfi_explained.pdf'
