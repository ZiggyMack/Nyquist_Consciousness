"""
Persona Contexts for EXP2-SSTACK Experiments
=============================================

Shared persona definitions used across all experiment phases.
Each persona has FULL, T3, and GAMMA context regimes.

FULL: Complete bootstrap with rich S-Stack knowledge (~2000 tokens)
T3: Tier 3 seed compression (~800 tokens)
GAMMA: Minimal name + role only (~100 tokens)
"""
