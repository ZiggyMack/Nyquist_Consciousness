...
**Package Type:** Funding proposal package (NSF/DARPA)
...
research for **NSF / DARPA / Open Philanthropy** submission.
...
*Package extracted from WHITE-PAPER/ for NSF / DARPA / Open Philanthropy submission.*