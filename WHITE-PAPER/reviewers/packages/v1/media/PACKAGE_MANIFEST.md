...
| Category | Files | Size |
|----------|-------|------|
| submissions/ | 4 files | 22.9 KB |
| guides/ | 1 files | 9.4 KB |

**Total:** 5 files, 32.3 KB
...
- `submissions\media\LLM_Unlocking_AI_Identity.md` (5.3 KB)
- `submissions\media\README.md` (5.2 KB)
- `submissions\popular_science\LLM_Ancient_Philosophy_Meets_Modern_AI.md` (9.0 KB)
- `submissions\popular_science\README.md` (3.3 KB)
