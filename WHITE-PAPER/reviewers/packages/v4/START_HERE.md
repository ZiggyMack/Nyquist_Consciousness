...
## Cold Boot Reading Order

If you're starting from zero context, read in this order:

### Phase 1: Orientation (15 min)
1. **This file** — You're here
2. `REVIEWER_BRIEF.md` — Full orientation with key numbers and terminology

### Phase 2: Core Claims (30 min)
3. `.shared/theory/MINIMUM_PUBLISHABLE_CLAIMS.md` — The 5 validated claims
4. `.shared/guides/summary_statistics.md` — Key statistics and methodology
...
### Phase 4: Deep Dive (Optional, 45 min)

6. `arxiv/submissions/arxiv/` — Full arXiv preprint draft
7. `.shared/planning/METHODOLOGY_DOMAINS.md` — Three methodology evolution
...
|---------------|------------------|
| Research overview | `REVIEWER_BRIEF.md` |
| Core claims | `.shared/theory/MINIMUM_PUBLISHABLE_CLAIMS.md` |
| Key statistics | `.shared/guides/summary_statistics.md` |
| Visual evidence | `visualization_pdfs/` |
| Full arXiv draft | `arxiv/submissions/arxiv/` |
| Workshop draft | `workshop/submissions/workshop/` |
| Journal draft | `journal/submissions/journal/` |
| Popular science | `popular_science/submissions/popular_science/` |
| Shared content | `.shared/` (theory, guides, planning, figures) |
...
See `REVIEWER_BRIEF.md` for the suggested feedback format.
