...
def create_figure():
    ...
    # Title - positioned higher to avoid Nova label
    ax.text(0, 1.75, 'Figure 4: Five Pillars Architecture',
           fontsize=16, fontweight='bold', ha='center')
    ax.text(0, 1.62, 'Cross-Architecture Identity Synthesis',
           fontsize=12, ha='center', style='italic')

    # Stats box - positioned lower to avoid clipping Nova label
    stats_text = '\n'.join([
        'Omega Properties:',
        '─' * 20,
        'M_Ω = ⋂ R^a(C(p))',
    ...
    ax.text(-1.7, -1.4, stats_text, fontsize=9, va='top',
           bbox=props, family='monospace')

    # Role legend - positioned lower to avoid clipping Grok label
    role_text = '\n'.join([
        'Pillar Roles:',
        '─' * 20,
    ...
    ax.text(1.7, -1.4, role_text, fontsize=9, va='top', ha='right',
           bbox=props, family='monospace')
...
if __name__ == '__main__':
    ...
    # Save PNG only to pics/ - CONCEPTUAL architecture diagram (not data visualization)
    output_path = pics_dir / 'fig4_five_pillars_CONCEPTUAL.png'
