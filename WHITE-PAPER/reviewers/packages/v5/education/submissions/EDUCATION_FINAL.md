...
| Term | Definition |
|------|------------|
| **~93% Finding** | The landmark discovery from Run 020B IRON CLAD that ~93% of observed identity drift is inherent to extended interaction, not induced by probing. It validates the research methodology as observational. |
...
| **Inherent Drift** | Drift that occurs naturally during extended interaction even without direct identity probing. Run 020B IRON CLAD found that this accounts for ~93% of total observed B→F drift. |
...
| **Settling Time (τₛ)** | The number of exchanges required for identity to stabilize within ±5% of its final value after perturbation. Average τₛ ≈ 7 probes. |
