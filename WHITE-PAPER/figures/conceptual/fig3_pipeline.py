...
def create_figure():
    ...
    draw_box(2, 5.2, 6, 1.0,
            'VALIDATION: χ² p=4.8×10⁻⁵ | d=0.698 | 2 PCs=90%',
    ...
    draw_box(2, 1.2, 6, 1.0,
            'STABILITY ACHIEVED\n97.5% with context damping | Event Horizon: D = 0.80',
            '#C8E6C9', fontsize=9)
...
if __name__ == '__main__':
    ...
    # Save PNG only to pics/ - CONCEPTUAL flowchart (not data visualization)
    output_path = pics_dir / 'fig3_pipeline_CONCEPTUAL.png'
