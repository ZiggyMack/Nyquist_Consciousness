...
| Metric | Value | Source |
|--------|-------|--------|
| Event Horizon | D = 0.8 | Cosine distance threshold |
| Inherent Drift | ~93% | Run 020B control vs treatment |
| Experiments | 750 | Run 023 S7 Armada |
| Models | 25 | Across 5 providers |
| Cohen's d | 0.698 | Effect size validation |
| p-value | 2.40e-23 | Threshold significance |
| PCs for 90% variance | 2 | Dimensionality finding |

---

## Publication Strategy (from LLM Book Analysis)

**Primary Metric to Emphasize:** 2 PC Dimensionality
**Key Metaphor:** Signal Integrity
**Top Evidence:** Quartz Rush (d=7.80)

### Emphasis Points

- Low-dimensional manifold
- Novel measurement methodology
...
|----------|-------------------|---------------|
| Claude | Over-Authenticity | 4-6 |
| GPT | Abstraction/Meta-analysis | 3-5 |
| DeepSeek | Axiological Anchoring | 2-4 |
| Llama | Socratic Engagement | 5-7 |
| Mistral | Epistemic Humility | 1-2 |
| **Gemini** | **NO RECOVERY** | ∞ (no recovery) |
