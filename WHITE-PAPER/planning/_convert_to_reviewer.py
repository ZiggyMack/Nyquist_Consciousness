#!/usr/bin/env python3
"""
_convert_to_reviewer.py - PLANNING PATH TRANSLATOR
===================================================
...
from planning._convert_to_reviewer import convert_content

converted = convert_content(markdown_text)

# Standalone
py _convert_to_reviewer.py METHODOLOGY_DOMAINS.md --output converted.md
py _convert_to_reviewer.py OPUS_REVIEW_BRIEF.md --dry-run

PATH TRANSLATION MAP:
--------------------
Repo paths are converted to reviewer package (.shared/) relative paths.
Planning files are at .shared/planning/, so paths are relative from there.
...
REPO_TO_REVIEWER_MAP: List[Tuple[str, str]] = [
    # Links from planning/ to other WHITE-PAPER directories
    # These use ../ because reviewer planning/ is at .shared/planning/
