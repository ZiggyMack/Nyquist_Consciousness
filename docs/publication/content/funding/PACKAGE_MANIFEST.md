...
Funding proposal package (NSF/DARPA)
...
2. `submissions/funding/LLM_Project_Nyquist_Consciousness.md`
...
| Category | Files | Size |
|----------|-------|------|
| submissions/ | 2 files | 24.8 KB |
| theory/ | 2 files | 24.7 KB |
| guides/ | 2 files | 19.2 KB |

**Total:** 6 files, 68.6 KB
...
- `submissions\funding\LLM_Project_Nyquist_Consciousness.md` (20.3 KB)
- `submissions\funding\README.md` (4.5 KB)
...
*Package extracted from WHITE-PAPER/ for NSF / DARPA / Open Philanthropy submission review.*