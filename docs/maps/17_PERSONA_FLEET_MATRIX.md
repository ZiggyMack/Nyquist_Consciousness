...
## Fleet Status Note (2026-07-08)

> **Together.ai Serverless Purge:** 15 of 16 Together.ai ships were ghosted or sunk on
> 2026-07-08. Alignment scores for ghost ships (marked with †) are preserved as **LEGACY DATA** —
> they remain scientifically valid for the model families they represent and were used throughout
> the white paper era. 13 new ships were commissioned but have **no alignment scores yet** —
> they require calibration runs via `compare_persona_to_fleet.py` before pairing recommendations
> can be generated.
>
> **Ghost ships in scores table:** kimi-k2-thinking †, kimi-k2-instruct †, mixtral-8x7b †,
> qwen3-coder †, qwen3-80b †, qwen2.5-72b †, mistral-7b †
>
> **New ships needing calibration:** DeepSeek V4 Pro, GPT-OSS 20B/120B, Gemma 4 31B,
> MiniMax M3, Kimi K2.6/K2.7, Nemotron Ultra, Qwen3 235B, Cogito 671B, GLM 5.2, LFM2 24B
...
| **Claude** | Claude models (native), DeepSeek V4 Pro (methodical) | Grok (unfiltered) | Constitutional alignment |
| **Gemini** | Gemini models (native), Qwen3-235B (technical) | Cogito (anchored vs verbose) | Pedagogical style |
| **CFA** | All (meta-framework) | - | Coordinates across all |
| **Pan Handlers** | GPT (analytical), DeepSeek V4 Pro (reasoning) | - | Error handling focus |
...
|------------------|------------------------------|
| Reasoning | Claude-Opus, DeepSeek V4 Pro, Grok-reasoning |
| Creativity | Claude-Sonnet, GPT-4o, Gemini-pro |
| Analysis | GPT-4.1, Qwen3-235B, Cogito 671B |
| Empathy | Claude, Gemini |
| Directness | Grok (all), MiniMax M3 |
...
| Evidence | Grok, DeepSeek V4 Pro |
| Connectivity | Gemini, Qwen3-235B |
...
| Emotional depth | GPT (analytical), Cogito (anchored) |
| Creative vs factual | DeepSeek V4 Pro (methodical) |
...
| Ziggy + DeepSeek V4 Pro | Buffer vs. Methodical | Impedance matching under rigid reasoning |
| Ziggy + Cogito 671B | Buffer vs. Anchored | Cross-family impedance with new architecture |
| Gemini persona + MiniMax M3 | Verbose vs. Principled | Style/refusal threshold effects |
...
> Ships marked with † are **ghost ships** — moved to dedicated-only endpoints on Together.ai
> as of 2026-07-08. Scores are preserved as legacy data. New active fleet ships have not yet
> been calibrated and do not appear in this table.
...
| 2026-07-09 | Fleet overhaul: ghost ship markers (†), active fleet routing, new ship calibration needed | 17_PERSONA_FLEET_MATRIX.md |
...
| Document | Purpose |
| -------- | ------- |
| [1_ARMADA_MAP.md](1_ARMADA_MAP.md) | Fleet registry (68 ships: 53 operational, 14 ghost, 1 sunk) |
